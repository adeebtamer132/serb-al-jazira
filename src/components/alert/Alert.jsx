...
export default function Alert({ emailSended = false, setEmailSendedMessage }) {
  return (
    <>
      {emailSended ? (
        <div
          onClick={() => setEmailSendedMessage(false)}
            ...
            <div className="flex">
              ...
              <div className="self-center ml-3">
                ...
                <p className="text-green-600 mt-1">
                  we got your Email we will get in Touch Soon, Thanks .
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="self-center ml-3">
                ...
                <p className="text-red-600 mt-1">
                  Sorry something wrong happened, Please Try Again or Contact Us
                  at marketing@serbaljazira.com .
                </p>
              </div>
            </div>
